...
int Wave2OpenFile(TCHAR*, HMMIO *, WAVEFORMATEX **, MMCKINFO *);
int Wave2StartDataRead(HMMIO *, MMCKINFO *, MMCKINFO *);
int Wave2ReadFile(HMMIO, UINT, BYTE *, MMCKINFO *, UINT *);
int Wave2CloseReadFile(HMMIO *, WAVEFORMATEX **);
